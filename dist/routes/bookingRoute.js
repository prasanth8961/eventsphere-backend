...
router.post("/bookings", authenticate.verifyToken, authenticate.isUserHaveAccess, BookingModel.createBooking);
// router.post(
//   "/bookings/confirm",
...
router.get("/bookings/confirmed", authenticate.verifyToken, authenticate.isUserHaveAccess, BookingModel.getUserBookedEvents);
