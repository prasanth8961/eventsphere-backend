...
const eventCategoryData_1 = require("./eventCategoryData");
const dotenv = __importStar(require("dotenv"));
dotenv.config();
const insertCategories = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log("Category seeder started");
        const categories = yield (0, knex_1.default)(table_1.tableName.CATEGORY).insert(eventCategoryData_1.eventCategoryData);
